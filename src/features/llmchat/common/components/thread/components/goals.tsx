import { StepRenderer, StepStatus, ToolCallStep, ToolResultStep } from '@repo@/features/llmchat/common/components';
import { useAppStore } from '@repo@/features/llmchat/common/store';
import { ChatMode } from '@repo@/features/llmchat/shared/config';
import { Step, ThreadItem, ToolCall, ToolResult } from '@repo@/features/llmchat/shared/types';
import { Badge } from '@repo@/features/llmchat/ui';
import {
    IconAtom,
    IconChecklist,
    IconChevronRight,
